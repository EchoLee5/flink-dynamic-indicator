...
import com.hundsun.art.dynamicrules.sources.BoundedRuleLoader;
...
import static com.hundsun.art.config.Parameters.STATE_TTL_MINUTES;
import static com.hundsun.art.dynamicrules.functions.ProcessingUtils.handleRulesCache;
...
public class DynamicIndicatorFunction extends KeyedBroadcastProcessFunction<
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        long ttl = Long.parseLong(globalJobParameters.get(STATE_TTL_MINUTES.getName()));
